...
const Entradas_1 = __importDefault(require("../models/Entradas"));
function getDespesasByUser(idUser) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield Entradas_1.default.find({ idUser });
    });
}
exports.getDespesasByUser = getDespesasByUser;
function addDespesa(despesa) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield Entradas_1.default.create(despesa);
    });
}
exports.addDespesa = addDespesa;
function deleteDespesa(_id) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield Entradas_1.default.findByIdAndDelete({ _id });
    });
}
